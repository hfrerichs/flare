...
def plot():
    ...
    flare.plot_data.plot_data(args.data_file, args.data_key, args.geometry_file, plot_function=args.plot_function, dimension=args.dimension, transpose=args.transpose)
    plt.show()
#===============================================================================
